...
public:
	...
	コンストラクタ
	***************************************/
	RotateTweener(std::shared_ptr<Transform>& ref, const D3DXVECTOR3& start, const D3DXVECTOR3& end, float duration, EaseType type, bool ignoreTimeScale, Callback callback) :
	...
	コンストラクタ
	***************************************/
	RotateTweener(std::shared_ptr<Transform>& ref, const D3DXQUATERNION& start, const D3DXQUATERNION& end, float duration, EaseType type, bool ignoreTimeScale, Callback callback) :
		Tweener<Transform>(ref, duration, type, ignoreTimeScale, callback),
		start(start),
		end(end)
	{
