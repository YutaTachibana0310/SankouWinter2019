...
public:
	...
	コンストラクタ
	***************************************/
	ScaleTweener(std::shared_ptr<Transform>& ref, const D3DXVECTOR3& start, const D3DXVECTOR3& end, float duration, EaseType type, bool ignoreTimeScale, Callback callback) :
